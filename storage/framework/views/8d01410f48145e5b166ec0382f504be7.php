...
<?php $component->withAttributes(['breadcrumb' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
    ...
    <!-- Datos Generales -->
    <form action="<?php echo e(route('admin.forms.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        ...
        <section>
            ...
            <div class="grid grid-cols-2 gap-4 mt-2">
                <div>
                    ...
                    <input type="date" name="fecha" id="fechaActual" value="<?php echo e(now()->format('Y-m-d')); ?>"
                        class="mt-1 block w-full p-2 border border-gray-300 rounded">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">Nombre del hotel asignado</label>
                    <input type="text" name="hotel" value="<?php echo e($namehotel); ?>"
                        class="mt-1 block w-full p-2 border border-gray-300 rounded">
                </div>
            </div>
        </section>
...
<?php endif; ?>
<?php /**PATH C:\wamp64\www\HotelRP24\resources\views/admin/forms/create.blade.php ENDPATH**/ ?>