...
<?php endif; ?>
<?php $component->withAttributes(['breadcrumb' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([['name' => 'Home', 'url' => route('admin.dashboard')], ['name' => 'Categorias']])]); ?>
     <?php $__env->slot('action', null, []); ?> 
        <a class="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700"
            href="<?php echo e(route('admin.categories.create')); ?>">Nuevo</a>
     <?php $__env->endSlot(); ?>
...
<?php endif; ?>
<?php /**PATH C:\wamp64\www\HotelRP24\resources\views/admin/categories/index.blade.php ENDPATH**/ ?>